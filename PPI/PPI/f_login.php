...
if (isset($_POST['login'])) {
    ...
    // Preparar e executar a consulta SQL para obter id, password_hash e tipo
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $hashed_password)) {
            // Credenciais corretas, armazenar o id, email e tipo de usuário na sessão
            $_SESSION['user_id'] = $user_id;   // Armazenando o ID do usuário logado
